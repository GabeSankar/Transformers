...
class Bert:
    ...
    def __init__(self, vocabFile, wordPiece, onlyLowercase):
        ...
        small_train_dataset = Tokenized_Dataset["train"].shuffle(seed=42).select(range(12800))
        ...
        small_test_dataset = Tokenized_Dataset["test"].shuffle(seed=42).select(range(3200))
